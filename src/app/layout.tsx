...
export const metadata: Metadata = {
  title: "Xeven Solutions - Transform Your Business with SaaS Platform",
  description: "Streamline operations and boost productivity with Xeven Solutions' comprehensive SaaS platform. Advanced analytics, automation, and 500+ integrations for modern enterprises.",
  keywords: "SaaS platform, business automation, analytics, workflow automation, integrations, enterprise software",
  metadataBase: new URL("https://xeven.com"),
  alternates: {
    canonical: "https://xeven.com"
  },
  openGraph: {
    title: "Xeven Solutions - Intelligent SaaS Platform for Modern Businesses",
    description: "Transform your business with our comprehensive suite of cloud-based tools. Advanced analytics, automation, and seamless integrations.",
    url: "https://xeven.com",
    siteName: "Xeven Solutions",
    images: [{
      url: "https://images.pexels.com/photos/577195/pexels-photo-577195.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Xeven Solutions dashboard"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Xeven Solutions - Transform Your Business with SaaS",
    description: "Streamline operations and accelerate growth with our intelligent SaaS platform.",
