...
const ButtonHoverBubble = ({
  ...
  return (
    <button
      ...
      className={cls(
        "group flex justify-center items-center rounded-theme relative cursor-pointer pointer-events-auto outline-none",
    ...
    >
      ...
      <div
        className={cls(
          "flex justify-center items-center h-9 px-4 rounded-theme relative",
