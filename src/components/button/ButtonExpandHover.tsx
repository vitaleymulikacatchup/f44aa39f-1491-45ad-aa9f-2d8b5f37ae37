...
const ButtonExpandHover = ({
  ...
  return (
    <button
      ...
      className={cls(
        "group relative cursor-pointer h-fit rounded-theme text-sm text-background pointer-events-auto outline-none",
    ...
    >
      ...
      >
        <div className="h-9 flex items-center" >
          <span
            className={cls(
              "relative z-10 md:transition-colors md:duration-[900ms] md:[transition-timing-function:cubic-bezier(.77,0,.18,1)]",
              textClassName
            )}
          >
            {text}
        ...
        <div className="absolute overflow-hidden top-[2px] bottom-[2px] left-[2px] right-[2px] rounded-theme flex justify-end">
          ...
          <div
            className={cls(
              ...
              "md:-translate-x-[calc(-100%+2.25rem-4px)] md:group-hover:translate-x-0",
              iconBgClassName
            )}
          ></div>
        </div>
